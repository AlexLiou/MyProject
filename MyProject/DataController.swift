...
class DataController: ObservableObject {
    // Responsible for loading and managing local data using CoreData, synced to iCloud
    let container: NSPersistentCloudKitContainer
    
    // inMemory means we'll create our data entirely in memory rather than on disk
